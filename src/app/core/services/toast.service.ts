...
export class ToastService {
  ...
  showWarning(text: string, options: any = {}) {
    this.toasts.push({ text, classname: 'bg-warning text-dark', header: 'Warning', ...options });
  }

  showSuccess(text: string, options: any = {}) {
    this.toasts.push({ text, classname: 'bg-success text-light', header: 'Success', ...options });
  }
  ...
  showInfo(text: string, options: any = {}) {
    this.toasts.push({ text, classname: 'bg-info text-light', header: 'Info', ...options });
  }
